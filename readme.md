...
```php
    'provider' => [
       Gw\Umeng\UmengServiceProvider::class, 
    ],
```
配置alias:
...
```php
    'aliases' => [
        'Umeng' => Gw\Umeng\Facades\Umeng::class,
    ],
```
...
```php
    $app->register(Gw\Umeng\UmengServiceProvider::class);
```

配置alias:

```php
    class_alias('Gw\Umeng\Facades\Umeng','Umeng');
```
